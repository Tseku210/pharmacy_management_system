...
public class ManagerController {
    ...
    @FXML
    void onInvoicesClick(MouseEvent event) {
        if (invoicesView == null) {
            try {
                invoicesView = FXMLLoader.load(getClass().getResource("invoices-manager.fxml"));
            } catch (IOException e) {
                e.printStackTrace();
                return;
            }
        }
        contentPane.getChildren().setAll(invoicesView);
    }
    ...
    void onPrescriptionClick(MouseEvent event) {
        if (prescriptionView == null) {
            try {
                prescriptionView = FXMLLoader.load(getClass().getResource("prescription-manager.fxml"));
            } catch (IOException e) {
                e.printStackTrace();
                return;
            }
    ...
    void onStockClick(MouseEvent event) {
        if (stockView == null) {
            try {
                stockView = FXMLLoader.load(getClass().getResource("stock-manager.fxml"));
            } catch (IOException e) {
                e.printStackTrace();
                return;
            }
    ...
    @FXML
    void onUsersClick(MouseEvent event) {
        if (usersView == null) {
            try {
                usersView = FXMLLoader.load(getClass().getResource("users-manager.fxml"));
            } catch (IOException e) {
                e.printStackTrace();
                return;
            }
